...
| Coût et latence par briefing | mesurés | **0,00 EUR par construction** (aucune passerelle LLM, aucun appel réseau dans le chemin de génération — cf. note ci-dessous) ; latence médiane 31-152 ms selon le cas (~31-46 ms cas riche/ambigu/sans données, ~152 ms cas pauvre qui déclenche réellement l'agent d'expansion) — depuis le 19-20/08/2026, cf. section 12 et 13 | `python scripts/mesurer_cout_latence_briefing.py` |
